  ...
  const styles = (
    <style>
      ...
      #nprogress{pointer-events:none}#nprogress .bar{background:${
        background
      };position:fixed;z-index:1031;inset:var(--barInset);width:100%;height:${
        height
      }px}#nprogress .peg{display:block;position:absolute;right:0;width:100px;height:100%;${
        boxShadow
      };opacity:1;-webkit-transform:var(--pegTransform);-ms-transform:var(--pegTransform);transform:var(--pegTransform)}#nprogress .spinner{display:block;position:fixed;z-index:1031;top:15px;right:15px}#nprogress .spinner-icon{width:18px;height:18px;box-sizing:border-box;border:2px solid transparent;border-top-color:${
        color
      };border-left-color:${
        color
